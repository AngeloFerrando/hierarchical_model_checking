...
andExpression: modalExpression (AND^ modalExpression)*;


modalExpression: notExpression | 
                 (AX^|EX^|EF^|EG^|AF^|AG^) modalExpression |
                 (FORALL^ | FORSOME^) LSQPAREN! untilExpression RSQPAREN!;

notExpression: (NEG^)? comparissonExpression;
