// $ANTLR 2.7.4: "boolpg.g" -> "BoolProgramLexer.java"$
...
public class BoolProgramLexer extends antlr.CharScanner implements BoolProgramLexerTokenTypes, TokenStream
 {
public BoolProgramLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BoolProgramLexer(Reader in) {
	this(new CharBuffer(in));
}
public BoolProgramLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BoolProgramLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("start", this), new Integer(29));
	literals.put(new ANTLRHashString("if", this), new Integer(35));
	literals.put(new ANTLRHashString("choice", this), new Integer(40));
	literals.put(new ANTLRHashString("fi", this), new Integer(38));
	literals.put(new ANTLRHashString("then", this), new Integer(36));
	literals.put(new ANTLRHashString("unknown", this), new Integer(33));
	...
	literals.put(new ANTLRHashString("skip", this), new Integer(34));
}
