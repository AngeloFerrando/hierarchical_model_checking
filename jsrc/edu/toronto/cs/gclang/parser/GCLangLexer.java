// $ANTLR 2.7.4: "gclang.g" -> "GCLangLexer.java"$
...
public class GCLangLexer extends antlr.CharScanner implements GCLangLexerTokenTypes, TokenStream
 {
public GCLangLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public GCLangLexer(Reader in) {
	this(new CharBuffer(in));
}
public GCLangLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public GCLangLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("NAME", this), new Integer(37));
	literals.put(new ANTLRHashString("boolean", this), new Integer(33));
	literals.put(new ANTLRHashString("if", this), new Integer(38));
	literals.put(new ANTLRHashString("VAR", this), new Integer(30));
	literals.put(new ANTLRHashString("INIT", this), new Integer(31));
	literals.put(new ANTLRHashString("fi", this), new Integer(41));
	literals.put(new ANTLRHashString("then", this), new Integer(39));
	...
	literals.put(new ANTLRHashString("RULES", this), new Integer(32));
	literals.put(new ANTLRHashString("skip", this), new Integer(36));
}
...
tryAgain:
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 9223371328185180672L, 4611686012387590142L, 0L, 0L};
		return data;
	}
