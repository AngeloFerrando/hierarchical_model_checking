...
public interface GnuCLexerTokenTypes {
	...
	int LITERAL___restrict = 143;
	int LITERAL_typeof = 144;
	int LITERAL___complex = 145;
	int LITERAL___builtin_va_list = 146;
	int LITERAL___attribute = 147;
	int LITERAL___pure__ = 148;
	int LITERAL___noreturn__ = 149;
	int LITERAL___nd_goto = 150;
	int LITERAL___alignof = 151;
	int LITERAL___real = 152;
	int LITERAL___imag = 153;
	int LITERAL___extension__ = 154;
	int IntSuffix = 155;
	int NumberSuffix = 156;
	int IDMEAT = 157;
	int WideCharLiteral = 158;
	int WideStringLiteral = 159;
}
