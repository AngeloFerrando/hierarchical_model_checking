...
public void initialize(AST tr) {
  ...
  public static void printTree(AST t) {
    printTree (t, new PrintWriter (System.out, true));
  }

  public static void printTree (AST t, PrintWriter out)
  {
    if (t == null) return;
    printASTNode(t, 0, out);
    // out.print("\n");
  }

  /** protected method that does the work of printing */
  protected static void printASTNode(AST t, int indent, PrintWriter out)
  {
     AST child1, next;
    ...
    out.print("\n");
     ...
     if(child1 != null) {
        printASTNode(child1,indent + 1, out);
