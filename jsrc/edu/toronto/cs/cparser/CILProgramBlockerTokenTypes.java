...
public interface CILProgramBlockerTokenTypes {
	int EOF = 1;
	...
	int Exponent = 162;
	int Number = 163;
	int LITERAL_typeof = 164;
	int LITERAL___complex = 165;
	int NInitializerElementLabel = 166;
	int LITERAL___label__ = 167;
	int LITERAL___alignof = 168;
	int LITERAL___real = 169;
	int LITERAL___imag = 170;
}
