// $ANTLR 2.7.4: "expandedGnuCParser.g" -> "GnuCLexer.java"$
...
public GnuCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("__real", this), new Integer(152));
	...
	literals.put(new ANTLRHashString("__pure__", this), new Integer(148));
	literals.put(new ANTLRHashString("__builtin_va_list", this), new Integer(146));
	literals.put(new ANTLRHashString("typeof", this), new Integer(144));
	literals.put(new ANTLRHashString("__nd_goto", this), new Integer(150));
	...
	literals.put(new ANTLRHashString("__noreturn__", this), new Integer(149));
	...
	literals.put(new ANTLRHashString("__imag", this), new Integer(153));
	literals.put(new ANTLRHashString("__alignof", this), new Integer(151));
	literals.put(new ANTLRHashString("static", this), new Integer(16));
	literals.put(new ANTLRHashString("continue", this), new Integer(41));
	literals.put(new ANTLRHashString("__restrict", this), new Integer(143));
	...
	literals.put(new ANTLRHashString("__extension__", this), new Integer(154));
	literals.put(new ANTLRHashString("asm", this), new Integer(5));
	literals.put(new ANTLRHashString("__complex", this), new Integer(145));
}
...
tryAgain:
	...
	public final void mNumber(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ( synPredMatched353 ) {
		...
		else if ((LA(1)=='0') && (LA(2)=='X'||LA(2)=='x') && (_tokenSet_2.member(LA(3)))) {
			match('0');
			{
			switch ( LA(1)) {
			case 'x':
			...
			if ( synPredMatched343 ) {
				...
				case '.':
				{
					...
					{
					if ((LA(1)=='E'||LA(1)=='e') && (_tokenSet_5.member(LA(2))) && (true)) {
						mExponent(false);
					}
					else {
					}
				...
				_loop351:
				do {
					if ((_tokenSet_6.member(LA(1))) && (true) && (true)) {
						_saveIndex=text.length();
						mNumberSuffix(false);
						text.setLength(_saveIndex);
					}
	...
	public final void mCharLiteral(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		match('\'');
		{
		if ((LA(1)=='\\') && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (_tokenSet_7.member(LA(3)))) {
			mEscape(false);
		}
		else if ((_tokenSet_8.member(LA(1))) && (LA(2)=='\'') && (true)) {
			{
			match(_tokenSet_8);
			}
		}
	...
	public final void mPREPROC_DIRECTIVE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((_tokenSet_12.member(LA(1))) && (_tokenSet_13.member(LA(2))) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff')))) {
			int _m450 = mark();
