/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cuddInt.h 2 2003-04-23 20:32:40Z arie $]
...
#endif
  /** ADDED by Arie Gurfinkel */
  void *data;                   /* pointer to store additional info*/
  /** END ADDED by Arie Gurfinkel */
};
